    ...
    return (
        <nav className={styles.nav}>
            ...
            <div className={`${styles.nav_container} ${navClass}`}>
                ...
                <ul className={styles.upa}>
                    <li className={styles.drpdwnlist} onMouseEnter={toggleIconUp1} onMouseOut={toggleIconDown1}>
                        ...
                        <ul>
                            ...
                            <li><a href='/' rel='noopener noreferrer' > <FontAwesomeIcon icon={faAngleRight} size='lg' className={styles.navdrbdwnbrandicon}/> <span className={styles.brnd}>White Paper</span></a></li>
                        </ul>
                    </li>
                ...
                <ul className={styles.upa}>
                    <li className={styles.ld}><a href='/' rel='noopener noreferrer'>Launch Dapp</a></li>
                </ul>
                </div>)
                }
            </div>
